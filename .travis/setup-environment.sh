...
for rt in $REQUIRED_JAVA_RUNTIMES; do
  case $rt in
     ...
     azul-zulu-1.8.0_40) install_azul_zulu "2015-03-8.6-bin" "1.8.0_45" "8.7.0.5";;
     ...
     azul-zulu-1.7.0_76) install_azul_zulu "2015-01-8.5-bin" "1.7.0_80" "7.10.0.1";;
     azul-zulu-1.7.0_76) install_azul_zulu "2015-01-8.5-bin" "1.7.0_79" "7.9.0.2";;
